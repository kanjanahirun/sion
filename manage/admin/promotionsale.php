...
if (!empty($_POST['Button'])) {
    ...
    if ($button == 'เพิ่มข้อมูล') {
        ...
        $sql = "UPDATE sale_promotion SET ID_SalePro = '" . $_POST["ID_SalePro"] . "',Promotion_Name = '" . $_POST["Promotion_Name"] . "',Discount = '" . $_POST["Discount"] . "',Start_Date = '" . $_POST["Start_Date"] . "',End_Date = '" . $_POST["End_Date"] . "' WHERE ID_SalePro = '" . $_POST["ID_SalePro"] . "'";
        mysql_query($sql);
    } else {
                                ...
                                <ul class="nav nav-tabs" role="tablist">
                                    <li class="active dropdown">
                                        <a class="point dropdown-toggle" data-toggle="dropdown" style="cursor: pointer;">
                                            โปรโมชันการขาย <span class="caret"></span>
                                        </a>
                                        <ul class="dropdown-menu" role="menu">
                                            <li><a href="./promotionservicedetail.php">รายละเอียดโปรโมชันการขาย</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="./promotionservice.php">โปรโมชันการให้บริการ</a></li>
